...
export const BUNNY = {
  ...
  STORAGE_BASE_URL: "https://storage.bunnycdn.com/screenie-tech",
  CDN_URL: "https://screenie-tech.b-cdn.net",
  EMBED_URL: "https://iframe.mediadelivery.net/embed",
  TRANSCRIPT_URL: "https://vz-3bc347db-1bf.b-cdn.net",
};

// Emojis for reactions/comments
export const emojis = ["😂", "😍", "👍"];

// Filter options for sorting videos
...
// Visibility options (make sure 'Visibility' type is defined elsewhere)
...
// Initial state for video uploads/processing
...
// Info tabs/sections for video details
export const infos = ["transcript", "metadata"];

// Default video and recording configurations
...
export const FALLBACK_RECORDING_CONFIG = {
